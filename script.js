...
function verifierCompte() {
    ...
    if (!savedUser || !savedPass) {
        msg.textContent = "⚠️ Aucun compte trouvé. Crée un compte.";
        btnRegister.style.display = "block";
    } else {
        msg.textContent = "🔐 Connecte-toi pour accéder au site.";
        btnRegister.style.display = "none"; // 🔥 caché après création
    }
}
...
document.getElementById("btn-register").addEventListener("click", () => {
    ...
    if (user && pass) {
        ...
        msg.textContent = "✅ Compte créé ! Maintenant connecte-toi.";

        verifierCompte(); // 🔥 IMPORTANT
    } else {
...
document.getElementById("btn-login").addEventListener("click", () => {
    ...
    if (!savedUser || !savedPass) {
        msg.textContent = "❌ Aucun compte. Crée-en un d'abord.";
        return;
    }
...
// 🔓 afficher bouton après connexion
document.getElementById("btn-login").addEventListener("click", () => {
    ...
    if (user === savedUser && pass === savedPass) {
        logoutBtn.style.display = "block"; // 🔥 afficher bouton
    }
});
...
logoutBtn.addEventListener("click", () => {
    ...
    document.getElementById("auth").style.display = "flex"; // remettre écran login
